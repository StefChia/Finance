...
class Tracker:
    ...
    def fill(self, save = True):
        ...
        while True:
            date = input('Date of the transaction (year-month-days): ')
            ...
            if macro_class.lower() == 'crypto':
                isin = input('Type the TICKER or n/a: ')
            ...
            values = [date, name, isin, macro_class, in_p, units,curr_p]
    ...
    def _update_trans_prices(self,data):
        ...
        for i in range(len(data)):
            ...
            name = names[i]
            macro = self.macro_class.get(name)   
            ...
            if macro == 'crypto':
                ...
                try:
                    ...
                    # IMPORTANT: always append something so lengths match
                    updated_price = np.nan
                    continue
                else: 
